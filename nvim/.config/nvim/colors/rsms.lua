...
local get_theme = function()
	...
	return {
		...
		-- Litterals
		["@string"] = { fg = c.value },
		["@string.regexp"] = { fg = c.value },
		["@string.escape"] = { fg = c.value },
		["@string.special"] = { fg = c.value },
		["@string.special.symbol"] = { fg = c.value },
		["@string.special.url"] = { fg = c.value },
		["@string.special.path"] = { fg = c.value },
		["@character"] = { fg = c.value },
		["@character.special"] = { fg = c.value },
		["@boolean"] = { fg = c.value },
		["@number"] = { fg = c.value },
		...
		["@function.method"] = { fg = c.fg_accent },
